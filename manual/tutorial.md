...
console.log('Generated id #2:', results[2].id )
```
...
The `anyRow()` will return a single row if it exists or `undefined` if it doesn't.
...
The `allRows()` will return an array of all matching rows.
